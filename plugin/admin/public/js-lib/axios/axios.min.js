!function (e, t) {
    ...
    var x = "undefined" == typeof self ? "undefined" == typeof global ? void 0 : global : self, N = function (e) {
        return !p(e) && e !== x
    };
    var C, P = (C = "undefined" != typeof Uint8Array && c(Uint8Array), function (e) {
        return C && e instanceof C
    }), k = l("HTMLFormElement"), _ = function (e) {
        var t = Object.prototype.hasOwnProperty;
        return function (e, n) {
            return t.call(e, n)
        }
    }(), B = l("RegExp"), D = function (e, t) {
    ...
    ["ERR_BAD_OPTION_VALUE", "ERR_BAD_OPTION", "ECONNABORTED", "ETIMEDOUT", "ERR_NETWORK", "ERR_FR_TOO_MANY_REDIRECTS", "ERR_DEPRECATED", "ERR_BAD_RESPONSE", "ERR_BAD_REQUEST", "ERR_CANCELED", "ERR_NOT_SUPPORT", "ERR_INVALID_URL"].forEach((function (e) {
        z[e] = {value: e}
    })), Object.defineProperties(F, z), Object.defineProperty(L, "isAxiosError", {value: !0}), F.from = function (e, t, n, r, o, i) {
    ...
    var H = U.toFlatObject(U, {}, null, (function (e) {
    ...
    function K(t, n, r) {
        ...
        n = n || new (I || FormData);
        var o, i = (r = U.toFlatObject(r, {metaTokens: !0, dots: !1, indexes: !1}, !1, (function (e, t) {
        ...
        function l(t, r, o) {
            var a = t;
            if (t && !o && "object" === e(t)) if (U.endsWith(r, "{}")) r = i ? r : r.slice(0, -2), t = JSON.stringify(t); else if (U.isArray(t) && function (e) {
        ...
        var d = [], h = Object.assign(H, {defaultVisitor: l, convertValue: f, isVisitable: J});
    ...
    function Q(e, t, n) {
        if (!t) return e;
        var r, o = n && n.encode || X, i = n && n.serialize;
        if (r = i ? i(t, n) : U.isURLSearchParams(t) ? t.toString() : new W(t, n).toString(o)) {
            var a = e.indexOf("#");
    ...
    var Z, G = function () {
        ...
        ee = "undefined" != typeof URLSearchParams ? URLSearchParams : W, te = FormData,
        ne = ("undefined" == typeof navigator || "ReactNative" !== (Z = navigator.product) && "NativeScript" !== Z && "NS" !== Z) && "undefined" != typeof window && "undefined" != typeof document,
        re = {
            isBrowser: !0,
    ...
    var ae = {
        ...
        transformRequest: [function (e, t) {
            var n, r = t.getContentType() || "", o = r.indexOf("application/json") > -1, i = U.isObject(e);
            if (i && U.isHTMLForm(e) && (e = new FormData(e)), U.isFormData(e)) return o && o ? JSON.stringify(oe(e)) : e;
            ...
            if (i) {
                if (r.indexOf("application/x-www-form-urlencoded") > -1) return function (e, t) {
                    return K(e, new re.classes.URLSearchParams, Object.assign({
                        visitor: function (e, t, n, r) {
                            return re.isNode && U.isBuffer(e) ? (this.append(t, e.toString("base64")), !1) : r.defaultVisitor.apply(this, arguments)
                        }
                    }, t))
                }(e, this.formSerializer).toString();
                if ((n = U.isFileList(e)) || r.indexOf("multipart/form-data") > -1) {
                    var a = this.env && this.env.FormData;
                    return K(n ? {"files[]": e} : e, a && new a, this.formSerializer)
                }
            }
    ...
    U.forEach(["delete", "get", "head"], (function (e) {
        ...
        ae.headers[e] = U.merge(ie)
    }));
    var se = ae,
        ue = U.toObjectSet(["age", "authorization", "content-length", "content-type", "etag", "expires", "from", "host", "if-modified-since", "if-unmodified-since", "last-modified", "location", "max-forwards", "proxy-authorization", "referer", "retry-after", "user-agent"]),
        ce = Symbol("internals");
    ...
    function le(e) {
        return !1 === e || null == e ? e : U.isArray(e) ? e.map(le) : String(e)
    }
    ...
    he.accessor(["Content-Type", "Content-Length", "Accept", "Accept-Encoding", "User-Agent"]), U.freezeMethods(he.prototype), U.freezeMethods(he);
    var pe = he;

    function me(e, t) {
        var n = this || se, r = t || n, o = pe.from(r.headers), i = r.data;
    ...
    var Oe = {
        http: null, xhr: "undefined" != typeof XMLHttpRequest && function (e) {
            return new Promise((function (t, n) {
                var r, o = e.data, i = pe.from(e.headers).normalize(), a = e.responseType;

                function s() {
                    e.cancelToken && e.cancelToken.unsubscribe(r), e.signal && e.signal.removeEventListener("abort", r)
                }

                U.isFormData(o) && re.isStandardBrowserEnv && i.setContentType(!1);
                ...
                if (u.open(e.method.toUpperCase(), Q(l, e.params, e.paramsSerializer), !0), u.timeout = e.timeout, "onloadend" in u ? u.onloadend = d : u.onreadystatechange = function () {
                    ...
                    var h = (e.withCredentials || we(l)) && e.xsrfCookieName && be.read(e.xsrfCookieName);
                    h && i.set(e.xsrfHeaderName, h)
                }
                void 0 === o && i.setContentType(null), "setRequestHeader" in u && U.forEach(i.toJSON(), (function (e, t) {
                    u.setRequestHeader(t, e)
                })), U.isUndefined(e.withCredentials) || (u.withCredentials = !!e.withCredentials), a && "json" !== a && (u.responseType = e.responseType), "function" == typeof e.onDownloadProgress && u.addEventListener("progress", Ee(e.onDownloadProgress, !0)), "function" == typeof e.onUploadProgress && u.upload && u.upload.addEventListener("progress", Ee(e.onUploadProgress)), (e.cancelToken || e.signal) && (r = function (t) {
                    u && (n(!t || t.type ? new ye(null, e, u) : t), u.abort(), u = null)
                }, e.cancelToken && e.cancelToken.subscribe(r), e.signal && (e.signal.aborted ? r() : e.signal.addEventListener("abort", r)));
                var p, m = (p = /^([-+\w]{1,25})(:?\/\/|:)/.exec(l)) && p[1] || "";
                m && -1 === re.protocols.indexOf(m) ? n(new F("Unsupported protocol " + m + ":", F.ERR_BAD_REQUEST, e)) : u.send(o || null)
            }))
        }
    };
    U.forEach(Oe, (function (e, t) {
        if (e) {
            try {
    ...
    var Se = function (e) {
        for (var t, n, r = (e = U.isArray(e) ? e : [e]).length, o = 0; o < r && (t = e[o], !(n = U.isString(t) ? Oe[t.toLowerCase()] : t)); o++) ;
        if (!n) {
            if (!1 === n) throw new F("Adapter ".concat(t, " is not supported by the environment"), "ERR_NOT_SUPPORT");
            throw new Error(U.hasOwnProp(Oe, t) ? "Adapter '".concat(t, "' is not available in the build") : "Unknown adapter '".concat(t, "'"))
        }
    ...
    function Ae(e) {
        return Re(e), e.headers = pe.from(e.headers), e.data = me.call(e, e.transformRequest), -1 !== ["post", "put", "patch"].indexOf(e.method) && e.headers.setContentType("application/x-www-form-urlencoded", !1), Se(e.adapter || se.adapter)(e).then((function (t) {
            return Re(e), t.data = me.call(e, e.transformResponse, t), t.headers = pe.from(t.headers), t
        }), (function (t) {
            return ve(t) || (Re(e), t && t.response && (t.response.data = me.call(e, e.transformResponse, t.response), t.response.headers = pe.from(t.response.headers))), Promise.reject(t)
        }))
    }
    ...
    Ne.transitional = function (e, t, n) {
        ...
        return function (n, o, i) {
            ...
            return t && !Ce[o] && (Ce[o] = !0, console.warn(r(o, " has been deprecated since v" + t + " and will be removed in the near future"))), !e || e(n, o, i)
        }
    };
    var Pe = {
    ...
    }, ke = Pe.validators, _e = function () {
        function e(n) {
            t(this, e), this.defaults = n, this.interceptors = {request: new G, response: new G}
        }

        return r(e, [{
            key: "request", value: function (e, t) {
                "string" == typeof e ? (t = t || {}).url = e : t = e || {};
                var n, r = t = Te(this.defaults, t), o = r.transitional, i = r.paramsSerializer, a = r.headers;
            ...
            key: "getUri", value: function (e) {
                return Q(ge((e = Te(this.defaults, e)).baseURL, e.url), e.params, e.paramsSerializer)
            }
        }]), e
    }();
    U.forEach(["delete", "get", "head", "options"], (function (e) {
        _e.prototype[e] = function (t, n) {
            return this.request(Te(n || {}, {method: e, url: t, data: (n || {}).data}))
        }
    })), U.forEach(["post", "put", "patch"], (function (e) {
        function t(t) {
    ...
    var Ue = function e(t) {
        var n = new Be(t), r = a(Be.prototype.request, n);
        return U.extend(r, Be.prototype, n, {allOwnKeys: !0}), U.extend(r, n, null, {allOwnKeys: !0}), r.create = function (n) {
            return e(Te(t, n))
        }, r
    }(se);
    return Ue.Axios = Be, Ue.CanceledError = ye, Ue.CancelToken = De, Ue.isCancel = ve, Ue.VERSION = xe, Ue.toFormData = K, Ue.AxiosError = F, Ue.Cancel = Ue.CanceledError, Ue.all = function (e) {
    ...
    }, Ue.AxiosHeaders = pe, Ue.formToJSON = function (e) {
        return oe(U.isHTMLForm(e) ? new FormData(e) : e)
    }, Ue.default = Ue, Ue
}));